...
function Library:CreateWindow(...)
    ...
    local function UpdateTitle()
        local rawTitle = Config.Title or "FourHub.lol";
...
local ThemeManager = {} do
	...
	ThemeManager.DefaultTheme = 'FourHub';
	...
	function ThemeManager:LoadDefault()
		local theme = self.DefaultTheme or 'FourHub';
...
do
    ...
    local function StyleNotification()
        ...
        for _, Outer in eli_ipairs(Area:GetChildren()) do
            if Outer:IsA("GuiObject") and not Outer:GetAttribute("FourHubStyled") then
                Outer:SetAttribute("FourHubStyled", true);
    ...
    if not Library.__FourHubNotifyHooked then
        Library.__FourHubNotifyHooked = true;
        Library.__FourHubOldNotify = Library.Notify;
        ...
        function Library:Notify(...)
            ...
            ApplyNotifySettings();
            local Data = Library.__FourHubOldNotify(self, ...);
...
ThemeManager:SetFolder('FourHub');
SaveManager:SetFolder('FourHub/rivals');
SaveManager:BuildConfigSection(Tabs['UI Settings'])

;(function()
    local lua_tab = Tabs.lua;
    local base_folder = SaveManager.Folder or 'FourHub/rivals';
...
;(function()
    local BRAND_ACCENT = Color3.fromHex('001EFF');
    ...
    pcall(function()
        ...
        wmbox:AddToggle('WatermarkFps', {
            ...
            Callback = function(v)
                getgenv().FourHub_wm = getgenv().FourHub_wm or {};
                getgenv().FourHub_wm.fps = v;
            end;
        });
    ...
    pcall(function()
        ...
        getgenv().FourHub_toggle_gui = toggleGui;
        local btn = Library:Create('TextButton', {
            Name = 'FourHubMobileToggle';
    ...
    pcall(function()
        ...
        if not holder or holder:FindFirstChild('FourHubMainResizer') then return end;
        local uis = game:GetService('UserInputService');
        local handle = Instance.new('Frame');
        handle.Name = 'FourHubMainResizer';
